...
object UpdateCheck {
    ...
    const val APK_LATEST = "https://github.com/phpcip/opensolr-mail/releases/latest/download/opensolr-mail.apk"

    private const val LATEST = "https://api.github.com/repos/phpcip/opensolr-mail/releases/latest"
            ...
            http.newCall(request).execute().use { response ->
                ...
                Result.success(
                    Update(
                        ...
                        pageUrl = json.optString("html_url").ifBlank { "https://github.com/phpcip/opensolr-mail/releases/latest" },
    ...
    private fun apkOf(json: JSONObject, tag: String): String {
        ...
        for (i in 0 until assets.length()) {
            ...
            if (a.optString("name") == "opensolr-mail.apk" && url.startsWith("https://github.com/phpcip/opensolr-mail/releases/download/v$tag/")) return url
        }
        return APK_LATEST
    }
